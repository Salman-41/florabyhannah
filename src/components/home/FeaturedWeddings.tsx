      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
          ...
          <RevealOnScroll delay={0.1} className="lg:col-span-7">
            <div className="block relative h-full min-h-[500px] lg:min-h-[700px] overflow-hidden rounded-2xl">
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#1A1A1A] via-[#1A1A1A]/60 to-transparent opacity-80" />

                {/* Decorative border */}
                <div className="absolute inset-0 border-2 border-[#FDFCF0]/0 rounded-2xl" />
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                <div className="space-y-4">
                  ...
                  <h3 className="text-3xl lg:text-5xl font-serif text-[#FDFCF0] leading-[1.2]">
                    {weddings[0].title}
                  </h3>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 lg:gap-8">
            {weddings.slice(1, 4).map((wedding, index) => (
              <RevealOnScroll key={wedding._id} delay={0.2 + index * 0.1}>
                <div className="block relative h-full min-h-[220px] overflow-hidden rounded-2xl">
                  <div className="absolute inset-0">
                    {wedding.coverImage && (
                      <Image
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1A1A1A]/95 via-[#1A1A1A]/50 to-transparent opacity-80" />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-7">
                    <div className="space-y-2.5">
                      ...
                      <h3 className="text-xl lg:text-2xl font-serif text-[#FDFCF0] leading-[1.3]">
                        {wedding.title}
                      </h3>
